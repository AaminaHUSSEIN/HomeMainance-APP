...
const BookingForm = () => {
  ...
  // URL-ka Server-ka oo sax ah
  const API_URL = 'https://homemainance-app-production.up.railway.app/api/bookings';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Halkan waxaan u beddelnay API_URL-ka saxda ah
      ...
      // Qalad kasta halkan ayaa lagu qabanayaa
